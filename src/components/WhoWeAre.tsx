...
const WhoWeAre = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 px-6 bg-[#0a0a0a]">
      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div className={`relative transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          <div className="relative aspect-[4/5] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#c89446]/20 to-transparent z-10" />
            <div className="absolute top-0 left-0 w-full h-full border-2 border-[#c89446] transform translate-x-4 translate-y-4" />
            <img
            ...
            />
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#c89446] flex items-center justify-center z-30">
        ...
        <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
          <div className="mb-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-[#c89446] tracking-[0.3em] text-sm uppercase font-light">The Jothom Story</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-black tracking-tight mb-6">
              WHO WE <span className="text-[#c89446]">ARE</span>
            </h2>
          </div>
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            ...
            <div className="relative border-l-4 border-[#c89446] pl-8 py-6 my-8 bg-black/30">
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#c89446] to-transparent" />
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-4xl font-black text-[#c89446] mb-2">500+</div>
              ...
              <div className="text-center border-l border-r border-gray-700">
                <div className="text-4xl font-black text-[#c89446] mb-2">98%</div>
                <div className="text-sm text-gray-400 uppercase tracking-wider">On-Time</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-[#c89446] mb-2">50+</div>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#c89446]/5 rounded-full blur-3xl" />
    </section>
  );
};
